...
O mesmo trabalho mapeia herança estática para generalização: “generalization relations are obtained from inheritance and from public methods with the same signature in different classes.”turn19file0L107-L110
...
A transformação ATL inclui: “for each dependency between two public methods, create a dependency between the corresponding use cases.”turn19file2L1-L7
...
De onde vem: mapeamento “método público → caso de uso” e “chamada entre públicos → dependência” (Pereira)turn19file0L101-L105turn19file2L1-L7; robustez semântica dos vetores via AST-encoder.
...
Recovering Use Case Diagrams from Object-Oriented Code: “Each public method of a class corresponds to a use case whose name is the same as the method name.”turn19file0L101-L105

Recovering Use Case Diagrams from Object-Oriented Code: “generalization relations are obtained from inheritance and from public methods with the same signature in different classes.”turn19file0L107-L110

Recovering Use Case Diagrams from Object-Oriented Code: “for each dependency between two public methods, create a dependency between the corresponding use cases.”turn19file2L1-L7

Recovering Use Case Diagrams from Object-Oriented Code: “we perform a propagation analysis on the data-flow graph”turn19file1L30-L37

Integrating Non-Fourier and AST-Structural Relative Position Representations…: “made up of two different types of encoders and one decoder…”turn22file3L17-L21; “…learn the structural information…”turn22file3L29-L33; “…allow the model to understand the semantics and syntax of the source code.”turn22file8L1-L5
